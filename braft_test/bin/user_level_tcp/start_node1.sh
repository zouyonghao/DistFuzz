...
LD_PRELOAD=/home/zyh/tldk/libtldk.so NODE_NAME=node1 "$bin_path"/atomic_server -reuse_addr -reuse_port -ip=10.0.1.2 -port=8300 -conf="10.0.1.1:8300:0,10.0.1.2:8300:0,10.0.1.3:8300:0," -data_path="./data1" > log1 2>&1 &
