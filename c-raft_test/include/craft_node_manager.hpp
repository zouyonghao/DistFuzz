#ifndef CRAFT_NODE_MANAGER_HEADER
#define CRAFT_NODE_MANAGER_HEADER

#include <craft_configuration_generator.hpp>

class CraftNodeManager : public NodeManager
{
public:
    CraftNodeManager(ServerConfigurationGenerator *_configuration_generator) : NodeManager(_configuration_generator) {}
