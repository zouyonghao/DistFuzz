...
__DST_ENV_RANDOM_FILE__=random_node1.txt $bin_path/redis-server --bind 127.0.1.1 --port 5002 --dbfilename raft2.rdb --loadmodule $lib_path/redisraft.so raft-log-filename raftlog2.db addr 127.0.1.1:5002 >> redis2.log 2>&1 &