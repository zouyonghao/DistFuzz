sudo apt install libboost-all-dev rapidjson-dev clang-9 libssl-dev libleveldb-dev libgflags-dev libprotobuf-dev libprotoc-dev protobuf-compiler libleveldb-dev autoconf
